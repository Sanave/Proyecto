...
// Display de formulario de información del cliente
/*
document.getElementById('boton_info').addEventListener('click',async ()=> {
    const formulario_actualizar = document.getElementById('formulario_actualizar');
    if (formulario_actualizar.style.display == 'block'){ formulario_actualizar.style.display = 'none'}
    else{formulario_actualizar.style.display = 'block'};

    const id = document.getElementById('boton_info').value;
